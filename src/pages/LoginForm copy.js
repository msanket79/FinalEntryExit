...
export default function LoginForm() {
  ...
  return (
    <>
      ...
      <Link to="../admin/home">Admin redirect</Link>
      <Link to="../security/home"> sec redirect</Link>
      <Link to="../staff/home"> staff redirect</Link>
      <Link to="../student/home"> student redirect</Link>
      <button
        onClick={() => {
          setAuth(true);
        }}
